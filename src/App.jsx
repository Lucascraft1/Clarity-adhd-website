    ...
    <section style={{background:S[50],borderTop:`1px solid ${S[100]}`,borderBottom:`1px solid ${S[100]}`,fontFamily:F}}>
      <div style={{maxWidth:1100,margin:"0 auto",padding:"36px 20px"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:24}}>
          {[["5-Visit","Structured Program"],["QbCheck","Objective Testing"],["3","Medication Trials"],["100%","Telehealth"]].map(([v,l])=>(
...
function Process({sRef}){
  const steps=[
    ...
    {week:"Week 5",title:"Choose the best fit",desc:"Last appointment. Switch to extended release of the medication that worked, then a 2-week trial after that visit. About 7 weeks from the first appointment.",icon:I.check,detail:"Transition to maintenance visits every 1-3 months"},
  ];
  return(
    <section ref={sRef} style={{padding:"80px 20px",background:"#fff",fontFamily:F}}>
      <div style={{maxWidth:640,margin:"0 auto"}}>
        <div style={{textAlign:"center",marginBottom:56}}>
          ...
          <p style={{fontSize:16,color:S[500],lineHeight:1.7}}>Most ADHD clinics spend 15 minutes and hand you a prescription. We take 5 visits, about 7 weeks start to finish, to systematically find your optimal treatment.</p>
        </div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(0,1fr)",gap:24,maxWidth:860,margin:"0 auto"}}>
          ...
          <div style={{background:`linear-gradient(135deg,${T},${TD})`,borderRadius:22,padding:32,color:"#fff",position:"relative",overflow:"hidden"}}>
            ...
            <div style={{position:"relative"}}>
              ...
              <p style={{color:"rgba(255,255,255,.7)",fontSize:13,marginBottom:20}}>Complete 5-visit program · about 7 weeks</p>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{background:S[50],borderRadius:14,padding:16,display:"flex",alignItems:"center",gap:12}}>
              ...
              <div>
                <p style={{fontWeight:600,color:S[800],fontSize:13,margin:"0 0 3px"}}>Add-On QbCheck</p>
  ...
  return(
    <section ref={sRef} style={{padding:"80px 20px",background:S[50],fontFamily:F}}>
      <div style={{maxWidth:680,margin:"0 auto"}}>
        ...
        <h2 style={{fontSize:"clamp(22px,3vw,32px)",fontWeight:800,color:S[900],marginBottom:28,lineHeight:1.25}}>Focused on adult ADHD care</h2>
        {/* provider card */}
        <div style={{display:"flex",alignItems:"center",gap:20,marginBottom:24}}>
          ...
          <div>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
              {["Board-Certified PA","WA Licensed PA","DEA Registered","Adult ADHD-focused"].map(b=>(
...
function FAQ({sRef}){
  ...
  const faqs=[
    ...
    ["Can you prescribe stimulants (Adderall, Vyvanse, etc.) via telehealth?","Yes, and we want to be direct about this because many telehealth clinics have stopped prescribing stimulants entirely. Telehealth controlled-substance prescribing is currently permitted when applicable federal and Washington requirements are met. We can prescribe Schedule II stimulant medications via telehealth after a thorough video evaluation, and we follow mandatory PDMP checks and other applicable rules."],
